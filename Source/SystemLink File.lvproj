	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Unit Test Framework tests" Type="Folder">
			<Item Name="serialization tests.lvtest" Type="TestItem" URL="../testing/serialization tests.lvtest">
				<Property Name="utf.test.bind" Type="Str">SystemLink File Module tests.lvlib:serialization tests.vi</Property>
			...
			<Item Name="init runtime test.lvtest" Type="TestItem" URL="../testing/init runtime test.lvtest">
				<Property Name="utf.test.bind" Type="Str">SystemLink File Module tests.lvlib:init runtime test.vi</Property>
		...
		<Item Name="SystemLink File configuration.lvclass" Type="LVClass" URL="../module/configuration/SystemLink File configuration.lvclass"/>
		<Item Name="SystemLink File runtime.lvclass" Type="LVClass" URL="../module/execution/SystemLink File runtime.lvclass"/>
		<Item Name="SystemLink File Module tests.lvlib" Type="Library" URL="../testing/SystemLink File Module tests.lvlib"/>
